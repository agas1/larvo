...
if ($id === null || !isset($shoppingItems[$id])) {
    header('Location: view.php');
    exit;
}

$item = $shoppingItems[$id];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (updateShoppingItem($id, $updatedItem)) {
        header('Location: view.php');
        exit;
    }
}
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <select name="category" id="category" required>
                    ...
                    <option value="Casa" <?= $item['category'] === 'Casa' ? 'selected' : '' ?>>Casa</option>
            ...
            <div class="form-group">
                <div class="checkbox-group">
                    <input type="checkbox" name="needed" id="needed" <?= $item['needed'] ? 'checked' : '' ?>>
                    <label for="needed" style="margin-bottom: 0; color: var(--gray-dark);">Item necessário</label>
                </div>
            </div>
