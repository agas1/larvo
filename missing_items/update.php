...
if ($id === null || !isset($missingItems[$id])) {
    header('Location: view.php');
    exit;
}

$item = $missingItems[$id];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (updateMissingItem($id, $updatedItem)) {
        header('Location: view.php');
        exit;
    }
}
...
<head>
    ...
    <title>Editar Item Faltante</title>
    <style>
        /* Mesmo estilo base */
        :root {
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <select name="priority" id="priority" required>
                    ...
                    <option value="Média" <?= $item['priority'] === 'Média' ? 'selected' : '' ?>>Média</option>
            ...
            <div class="form-group">
                ...
                <textarea name="notes" id="notes"><?= htmlspecialchars($item['notes']) ?></textarea>
            </div>
